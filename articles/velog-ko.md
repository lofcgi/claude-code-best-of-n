...
프롬프트 795줄 전체를 [GitHub에 공개](https://github.com/lofcgi/claude-code-fast-proto)해뒀습니다.
---
...
cd claude-code-fast-proto/kor    # 영어: cd eng
```
...
Star 눌러주시면 큰  [이슈에 이메일 남기시면](https://github.com/lofcgi/claude-code-fast-proto/issues/new?template=prd-template-request.md) 위 두 프로젝트를 만들 때 사용한 PRD라도 보내드리겠습니다!
