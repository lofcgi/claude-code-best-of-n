...
In Phase 3, Read this file and create the following components in `components/premium/`.
Each component is a complete, production-level implementation. Do not simplify or omit anything.

---

## 1. background-beams.tsx

SVG beams + framer-motion pathLength animation. Hero Layer 2 option.
...
Conic-gradient expansion animation. Aceternity LampContainer pattern. Hero Layer 2 option.
...
3-layer gradient + CSS @keyframes aurora. Hero Layer 2 option.
...
CSS rotate(215deg) translateX + random placement + ::after tail. Hero Layer 5 option.
...
> Note: `@keyframes meteor` is defined in globals.css. See the Phase 3 globals.css extension section.

---

## 5. sparkles.tsx

Framer-motion floating particles (y/opacity oscillation). Hero Layer 5 option.
...
Background-clip: text gradient span. Essential component for typography emphasis.
...
macOS Dock-style bottom navigation. Framer-motion hover scale.
