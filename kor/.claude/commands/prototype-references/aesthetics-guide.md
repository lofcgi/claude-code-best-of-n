...
7. **적은 섹션 수 (8개 미만)** → 최소 8개 섹션
8. **보수적 타이포 (text-4xl Hero)** → text-6xl md:text-8xl font-black
9. **기본 filled 버튼 (glow 없음)** → glow box-shadow 30px+ 필수
10. **Inter/Roboto/Arial 폰트** → 권장 폰트 사용
11. **Hero 배경이 단일 CSS gradient** → 5-layer 필수
12. **py-24/py-32 섹션 패딩** → py-40 최소
